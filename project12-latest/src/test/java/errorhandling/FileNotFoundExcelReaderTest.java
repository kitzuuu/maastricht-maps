...
class FileNotFoundExcelReaderTest {
    ...
    void testError() throws InterruptedException {
        ...
        Platform.runLater(() -> {
            try {
                FileNotFoundExcelReader.error(infoLabel);
            } finally {
                latch.countDown();
            }
        });
        ...
        assertEquals("The excel file was not found! Api will be used instead.", infoLabel.getText());
    }
}
