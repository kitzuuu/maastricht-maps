 ...
 * It contains a method to get the bike route between two coordinates.
 */
public class ApiGraphHopperBike {
     ...
     * points.
     *
     * @param coords1String The coordinates of the first point.
     * @param coords2String The coordinates of the second point.
    ...
    public static ArrayList<String> call(String[] coords1String, String[] coords2String) throws IOException {
        ...
        Request request = new Request.Builder()
                .url(STR."https://graphhopper.com/api/1/route?point=\{coords1String[0]},\{coords1String[1]}&point=\{coords2String[0]},\{coords2String[1]}&profile=bike&locale=en&calc_points=true&points_encoded=false&key=\{KEY}")
                .get()
                .build();
